...
public:
    ...
    QList<Timbratura> timbratureOrdinarie() const;
    int minutiLavoratiNelGiorno() const;
    Utilities::Turno tipoTurno() const;

    void setData(const int &anno, const int &mese, const int &giorno);
