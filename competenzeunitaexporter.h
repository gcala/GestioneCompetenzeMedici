...
private:
    ...
    void printIntestazione(QPainter &painter, int column, int rowSpan, int colSpan, int rotation, const QString &text);
    void printCell(QPainter &painter, int row, int column, int colSpan, const QString &text);
    QFont numberFont();
    QFont unitaFont();
    QFont headerFont();
