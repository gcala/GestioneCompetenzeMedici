...
{
public:
    explicit SqliteDataProvider(const QString& connectionName, QObject* parent = nullptr);
    ...
    // In sqlitedataprovider.h, aggiungi nella dichiarazione della classe
...
private:
    int doctorId(int matricola);
    int insertDoctor(int matricola, const QString& nome, const QString& id_unita);
    bool timeCardExists(const QString& tableName, int doctorId);
    void resetTimeCard(const QString& tableName, int doctorId);
};
