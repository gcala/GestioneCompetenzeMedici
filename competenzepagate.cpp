...
int CompetenzePagate::indFestiva() const
{
...
int CompetenzePagate::guard_diu() const
{
...
void CompetenzePagate::setIndFestiva(const int indFestiva)
{
...
void CompetenzePagate::setGuard_diu(const int guard_diu)
{
