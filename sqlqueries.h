...
public:
    ...
    static void insertPayload(const int &id_unita, const QString &data, const int ore_tot, const int ore_pagate, const int paga_diurno);
    ...
    static QMap<QDate, QVector<int> > getOrePagateFromUnit(const int &unitaId);
...
//    static bool noStraordinario(int matricola);
    static bool abilitatoStraordinario(int matricola, const int &anno, const int &mese);
//    static void enableDisableStraordinario(int matricola, bool enable);
    static void abilitaDisabilitaStraordinario(int matricola, bool enable, const int &anno, const int &mese);
    ...
    static int idSituazioneSaldo(const int anno, const int mese, const int matricola);
    static void addSituazioneSaldo(const int anno, const int mese, const int matricola, const int saldo, const int rmp, const int dmp);
    static void updateSituazioneSaldo(const int id, const int saldo, const int rmp, const int dmp);
};
